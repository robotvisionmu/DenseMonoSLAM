...
void main()
{
    ...
    if(!(!actv && vTimes[timeIdx] == -3) && (vPosHome.z > maxDepth || vPosHome.z < 0 || vPosition.w < confThreshold ||
       (actv && vTimes[timeIdx] == -3) ||
       (vTimes[timeIdx] != -3 && time - vTimes[timeIdx] > timeDelta) || 
       vTimes[timeIdx] > maxTime))
    {
