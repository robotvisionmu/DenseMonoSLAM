...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["GeForce GTX 960M"] = std::pair<int, int>(64, 80);
            rgbStepMap["GeForce GTX 960M"] = std::pair<int, int>(160, 32);
            rgbResMap["GeForce GTX 960M"] = std::pair<int, int>(128, 496);
            so3StepMap["GeForce GTX 960M"] = std::pair<int, int>(128, 32);

            icpStepMap["GeForce GTX 1080 Ti"] = std::pair<int, int>(256, 112);
            rgbStepMap["GeForce GTX 1080 Ti"] = std::pair<int, int>(80, 128);
            rgbResMap["GeForce GTX 1080 Ti"] = std::pair<int, int>(256, 224);
            so3StepMap["GeForce GTX 1080 Ti"] = std::pair<int, int>(448, 48);
