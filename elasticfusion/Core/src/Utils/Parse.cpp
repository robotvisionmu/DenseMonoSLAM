...
int Parse::arg(int argc, char** argv, const char* str, std::vector<std::string> &val) const
{
    int index = findArg(argc, argv, str) + 1;
...
bool Parse::arg(int argc, char** argv, const char* str) const
{
    return findArg(argc, argv, str) > -1;
}  
