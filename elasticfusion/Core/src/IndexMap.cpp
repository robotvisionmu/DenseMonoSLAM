                              ...
                              const int timeDelta)
{
    ...
    indexProgram->setUniform(Uniform("timeIdx", timeIdx));
                               ...
                               IndexMap::Prediction predictionType)
{
    ...
    combinedProgram->setUniform(Uniform("timeIdx", timeIdx));
    combinedProgram->setUniform(Uniform("maxTime", maxTime));
    combinedProgram->setUniform(Uniform("timeDelta", timeDelta));
    combinedProgram->setUniform(Uniform("actv", predictionType == IndexMap::ACTIVE));
                               ...
                               const int timeDelta)
{
    ...
    depthProgram->setUniform(Uniform("timeIdx", timeIdx));
